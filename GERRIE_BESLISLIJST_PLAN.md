...
> **Status:** PO akkoord met alle voorstellen (2026-09-13). **Fase 0 GEBOUWD** op 2026-09-13, zie [CHANGELOG_GERRIE_BESLISLIJST_FASE0_2026-09-13.md](CHANGELOG_GERRIE_BESLISLIJST_FASE0_2026-09-13.md). Fase 1 nog niet gestart. Werknaam: *beslislijst*; de naam in de app staat nog open (sectie 9).
...
| 2 | `quote_expiring` | veegronde: `status='sent'` en `valid_until` binnen 3 dagen | `quote:<id>:expiring` · direct | regel | `propose_edit_quote` → `valid_until` + 14 dagen | finance | *Verloopt over 2 dagen; klant heeft nog niet gereageerd.* |
