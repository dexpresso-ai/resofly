...
Dat draait vijf migraties, in volgorde en veilig om te herhalen:
...
| `20260918000000_mcp_execute.sql` | `mcp_grants.scope_ceiling`; de eigenaar mag zijn eigen scope wijzigen; melding ook bij een uitvoering |
