-- ============================================================
-- ResoFly — Zakelijke module: foutmelding bij de administratielimiet
-- Date: 2026-08-07
--
-- 20260807000000 verwees bij het bereiken van de administratielimiet naar
-- "Instellingen → Abonnement" om er een bij te kopen, maar dat is nog geen
-- self-service: entity_addons wordt handmatig gezet. Een gebruiker zou dus naar
-- een knop zoeken die er niet is. Alleen de meldingstekst wijzigt.
-- ============================================================
