...
begin
  ...
  begin
    ...
    -- een kerntool-voorstel (zie 20260917040000), en pas dan de algemene tekst.
    -- Die middelste stap hoort er echt bij: deze migratie is naast 040000
    -- geschreven en zou hem zonder die regel stil ongedaan maken. Een uitvoering
    -- heeft altijd de registry-vorm, want een kerntool wordt nooit rechtstreeks
    -- uitgevoerd.
    v_title := coalesce(
