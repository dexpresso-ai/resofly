...
//
// Deze frontend-kopie levert de chips in de editor, de live voorbeeldweergave
// en de waarschuwing over onbekende tokens vóór verzending.
//
// BELANGRIJK: dit is een SPIEGEL van supabase/functions/_shared/mergeTokens.ts,
// die het echte invullen bij het versturen doet. Wijzig je de tokenset of de
// invul-logica hier, doe het daar dan óók — anders wijkt de voorbeeldweergave
// af van wat de klant werkelijk ontvangt.
// ============================================================
