...
const JOURNALS: { jrnID: string; desc: string; jrnTp: string; sources: string[] }[] = [
  ...
  { jrnID: 'MEM', desc: 'Memoriaal', jrnTp: 'M', sources: ['manual', 'asset_depreciation', 'asset_acquisition', 'asset_disposal', 'vat_return', 'year_close', 'result_appropriation', 'corporate_tax', 'dga_interest', 'payroll', 'dividend'] },
];
